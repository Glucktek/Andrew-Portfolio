...
function makeHandler(_config) {
  return async function keystaticAPIRoute(context) {
    var _context$locals,
      ...
      _config$secret;
    const envVarsForCf =
      (_context$locals = context.locals) === null ||
      _context$locals === void 0 ||
      (_context$locals = _context$locals.runtime) === null ||
      _context$locals === void 0
        ? void 0
        : _context$locals.env;
    const handler = makeGenericAPIRouteHandler(
      {
        ...
        clientId:
          (_ref =
            ...
            _config$clientId !== void 0
              ? _config$clientId
              : envVarsForCf === null || envVarsForCf === void 0
                ? void 0
                : envVarsForCf.KEYSTATIC_GITHUB_CLIENT_ID) !== null &&
          _ref !== void 0
            ? _ref
            : tryOrUndefined(() => {
                return undefined;
        ...
        clientSecret:
          (_ref2 =
            ...
            _config$clientSecret !== void 0
              ...
              : envVarsForCf === null || envVarsForCf === void 0
                ? void 0
                : envVarsForCf.KEYSTATIC_GITHUB_CLIENT_SECRET) !== null &&
          _ref2 !== void 0
            ? _ref2
            : tryOrUndefined(() => {
                return undefined;
        ...
        secret:
          (_ref3 =
            (_config$secret = _config.secret) !== null &&
            _config$secret !== void 0
              ? _config$secret
              : envVarsForCf === null || envVarsForCf === void 0
                ? void 0
                : envVarsForCf.KEYSTATIC_SECRET) !== null && _ref3 !== void 0
            ? _ref3
            : tryOrUndefined(() => {
                return undefined;
              }),
    ...
    if (headers) {
      if (Array.isArray(headers)) {
        ...
        if (
          ...
          if (
            setCookieHeaders2 !== null &&
            setCookieHeaders2 !== void 0 &&
            setCookieHeaders2.length
          ) {
...
const KeystaticAdmonition = ({ variant, children }) => {
  ...
  return /* @__PURE__ */ jsxs("div", {
    className: "ks-admonition",
    style: { borderColor: color },
    children: [
      /* @__PURE__ */ jsx("h5", {
        className: "ks-admonition__variant",
        children: variant,
      }),
...
const Admonition = wrapper({
  label: "Admonition",
  ContentView: (props) =>
    /* @__PURE__ */ jsx(KeystaticAdmonition, {
