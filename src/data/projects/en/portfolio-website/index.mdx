...
keyFeatures:
  ...
  - GitOps deployment: PR previews and merge-driven releases
...
The project integrates SEO fundamentals (structured data, canonical and hreflang tags, RSS), performance-conscious images with `astro:assets`, and a component library emphasizing semantic HTML and a11y.
...
- i18n: Data translations via `src/config/translationData.json.ts` and route translations; locale-aware utilities and link generation.
